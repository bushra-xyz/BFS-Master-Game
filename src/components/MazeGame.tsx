...
export default function MazeGame() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-4">
      ...
      <footer className="-mt-2 text-[10px] sm:text-xs font-display tracking-[0.25em] uppercase italic text-center text-accent drop-shadow-[0_0_8px_hsl(var(--accent)/0.5)]">
        ⟡ Developed by{" "}
        <span className="font-bold not-italic text-primary drop-shadow-[0_0_10px_hsl(var(--primary)/0.7)]">
          Bushra Jannat
        </span>
        {" "}&{" "}
        <span className="font-bold not-italic text-[#ff00ff] drop-shadow-[0_0_10px_rgba(255,0,255,0.7)]">
          Miftahul Jannat
        </span>
        {" "}⟡
      </footer>
